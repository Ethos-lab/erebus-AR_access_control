...
namespace Erebus
{
    namespace LanguageManager
    {
        public class DataController : MonoBehaviour
        {
            ...
            [SerializeField]
            private string[] policyCodeFileNames = new string[5]
            { "input1.erebus", "input2.erebus", "input3.erebus", "input4.erebus", "input5.erebus" };
            private string[] policyCodeFilePaths = new string[5]; //Local storage path
            ...
            private void Awake()
            {
                ...
                //For logical external storage (shared internal): Downloads folder in Android
                //For SD card : storage/0000-0000/Android/data/com.Yoonsang.ErebusPermissionManager/files/
            ...
            public void LoadSavedData()
            {
                ...
                else
                {
                    ...
                    SetAppData("AR Navigation", new App
                    {
                    ...
                    SetAppData("AR Furniture Preview", new App
                    {
                        codeAssemblyBytes = null,
                    ...
                    SetAppData("AR Toy Monsters", new App
                    {
                        codeAssemblyBytes = null,
                    ...
                    {
                        codeAssemblyBytes = null,
                        langFilePath = Path.Combine(myDataSaveBasePath, "input5.erebus"),
                        langVoiceCommandInput = "",
                        lastModified = curTime
                    });
                    ApiPolicyLastModified = curTime;
                    Debug.Log($"File initialized [Applications] : {myAppDataSavePath}");
                }
                ...
                else
                {
                    ...
                    Debug.Log($"File initialized [Attributes] : {myAppDataSavePath}");
                }
            }
